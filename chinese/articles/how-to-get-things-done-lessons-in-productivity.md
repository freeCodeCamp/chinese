...
![心理学分析：如何以良好状态提高开发的效率](https://images.unsplash.com/photo-1547809397-e2c7eea071fa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxMTc3M3wwfDF8c2VhcmNofDYxfHxtYWdpY3xlbnwwfHx8&ixlib=rb-1.2.1&q=80&w=2000)
...
哦对了，我还用了 [Trello][6] 前后装卸过 3 次，因为每个人都在说它特别特别好用。
...
我现在用的是 Google Keep。但当你接着往下读的时候，我希望你能自动把它替换为你最爱的那款应用，或是 “_Todoist_”，或是 “_One Note_”，或是别的，都没问题。
...
[Image Credi][7][t][8] – 首先，你要确定自己的核心生产效率工具，然后把其它工具作为它的辅助。
...
[Image Credit][10] – 我们急于去追求最新的生产效率和时间管理工具，可单凭工具的使用并不能解决问题。

这一观点颇受争议。

之前曾有人站出来质疑过我，尤其是一款名为 Notion 的新应用走红以后（[Notion][11]）。
...
[Image credit][12] – 配合使用纸质工具和电子工具，让你的工作效率得到充分发挥。
...
所以说，当你打开我在 Google keep 上的 “_重大目标_” 标签时，你会发现一大堆的照片。
...
这张照片就存在我的 Google Keep 中，它是我在一次头脑风暴中写下的，主题是行为心理学中可帮助创业者减轻拖延倾向的方法。
...
[Image Credit][14]  – 要想建立强大的时间管理能力，你需要经常回顾总结。
...
- 如果你在构建一个作品集，接下来的最小一步就是打开一个文档，写下一个粗略的计划。而不是打开 visual studio，[捣鼓 C++ 里的各种小技巧][18]。
...
[Image Credit][20] – 拖延症是一个需要用心理学的方法来解决的心理学问题。
...
- **截止日期效应**：打开网址 [www.tomato-timer.com][21]，设置一个 5 分钟的倒计时，然后尽最快速度去开始着手你的下一个最小一步。大多数情况下，你会发现自己工作了不止 5 分钟。这就对了，因为在 [蔡格尼克记忆效应][22] 作用下，你会倾向完成你已经开始的工作。
- **负面增强，直到你开始工作为止**：如果你发现自己不知为什么在这 5 分钟啥也没干计时器就截止了，那就重新开始计时。一条附加的建议是，打开计时器设置，设置一个你极其讨厌的提醒铃声。重复这个过程 5 遍，每一遍都通过看着倒计时触发铃声的方式来惩罚自己！
...
[Image Credit][24] – 如果你的工作流程设计合理的同时又能让你照顾好自己，你便能主宰自己的工作，减轻焦虑。

完成一些任务后并不总是意味着要接着做更多。有时，你需要的不再是更快、更好。

而是照顾好自己的理智。

> “ _自我照顾绝不是自私的体现。每当我们倾听真我并对其予以需要的关怀时，我们并不仅是为了自己才那么做，也是为了与我们的生命有交集的诸多他人_。” - 帕克·帕尔默
...
[Image Credit][25] – 拥有一个专门用于休息的地方能够帮你完全放松下来。
...
[Image Credit][26] – 每天洗个澡，看似简单，却足以让你恢复身心。
...
[Image Credit][27] – 烹饪是让你自己重启的最佳方式之一。
...
[Image Credit][28] – 有时，迈步到阳光下就是你所需的高效触发器。
...
[Image Credit][30] – 有些行动虽然微小、不起眼，但却可以让你为身临大战做好准备。

> 有些事情可能并不起眼，但在涟漪效应下，这些小事情也能发挥大作用。– [马特·贝文][31]
...
[**在 Twitter 上关注我**][34]：需要更多高效工作的技巧？或是有任何疑问？我的 Twitter 账号最为活跃，欢迎随时 [与我联系][35]。我的私信已打开。

[**阅读更多文章**][36]：如果您想阅读更多文章，也欢迎 [查看我博客上的其他文章][37]。

_小贴士_ - 我喜欢做研究，所以我倾向用行为心理学和神经科学的概念来支撑我的建议和方法。
...
[36]: https://www.freecodecamp.org/news/author/lifetechpsych/
[37]: https://www.freecodecamp.org/news/author/lifetechpsych/ 
