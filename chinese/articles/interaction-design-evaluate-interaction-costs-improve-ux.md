...
了解交互成本是任何现代产品设计师的一项重要技能。我们鼓励你超越表面的交互设计考虑，深入研究众多的PIC和MIC因素。
...
我还在Facebook上运营一个[私人指导小组](https://www.facebook.com/groups/richarduxmentorship)和一个设计[Instagram](https://www.instagram.com/richard.ux/)账户。
