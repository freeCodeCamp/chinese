...
这些都是程序员经常谈到的共同话题，也是每个开发团队都会经历的阶段。
...
那么，你是怎样一步一步成为事故中的受害者的？没人关心这个。你应该这样问：如何我才能不成为编程事故的受害者？
...
一致性是保持简洁的重要部分。如果你在某个地方以某种方式做一件事情，那你在每个地方都要这么做。举个例子，如果你命名一个变量为“thisIsVariable”，那你所有的变量都要这样命名（otherVariable，anAnotherVariable等等这些都不可以）。
