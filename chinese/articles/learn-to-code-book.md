...
## 本书献给 freecodecamp 全球社区。

感谢所有在过去 8 年中支持我们慈善机构和使命的人们。
...
### 故事时间：一个 30 多岁的老师是怎么教他自己学编程的？

我曾是运营一间英文学校的老师。我们有大概 100 个从世界各地前往加州的成年学生。他们通过学习提高英语能力以进入研究生学校。

学校的大部分老师热爱教学。他们热衷于和学生在城市闲逛，以帮助他们提高口语能力。

但这些老师并不喜欢文书工作：出勤报告。成绩报告。移民文书工作。

我希望老师们能花更多的时间和学社一起度过。更少的时间被束缚在办公桌上做文书工作。

但我对计算机了解什么呢？

编程？难道你不需要聪明才智就能会编程吗？我甚至不能配置一个 WiFi 路由器。并且我讨厌数学。

直到有一天，我决定把一切都放一边，然后自己想：“我要去试一试编程。试一试我能失去什么呢？”

我开始在谷歌上搜索诸如“如何自动点击浏览网站”之类的问题。以及“如何将网站数据导入 Excel”。

我当时没有意识到，但我正在学习如何自动化工作流程。

于是学习开始了。首先是 Excel 的宏。然后是一个叫 AutoHotKey 的工具，在那里你可以对你的鼠标进行编程，使其移动到屏幕的某些坐标上，点击，复制文本，然后移动到不同的坐标上并粘贴它。

在黑暗中摸索了几周后，我想出了如何将一些任务自动化。我可以打开一个 Excel 电子表格和一个网站，运行我的脚本，然后在 10 分钟后回来，电子表格将被完全填充。

这是一个业余爱好者的工作。开发人员可能称之为 "肮脏的黑客"。但它完成了工作。

我利用我新发现的自动化技能，继续简化学校的工作。

很快，老师们几乎不需要碰电脑。我只是用我最基本的技能，就完成了几个老师的工作。

这对学校产生了明显的影响。我们的很多时间都被电脑上的死记硬背捆绑住了。而现在我们有了自由。
...
我在桌游之夜认识了一些软件工程师。他们有传统的背景，拥有加州理工学院、哈维穆德学院和其他著名计算机科学课程的学位。
...
还有："这是个竞争相当激烈的领域。你怎么能和那些从小就开始编码的人混在一起？"

还有："你作为一名教师已经做得很好了。你为什么不坚持做你擅长的事情？"

而这将使我在几个星期内偏离方向。我会在晚上进行长时间的反思性散步。我会在星空下思索我的未来。这些人是对的吗？我是说--他们会知道的，对吗？
...
这就像……多年来，医生认为一个人在 4 分钟内跑完一英里是不可能的。他们认为你的心脏会因为跑得这么快而爆炸。

但后来有人成功做到了。而他的心脏并没有爆炸。

一旦 Roger Bannister ——一个 25 岁的牛津大学学生--打破了这个心理障碍--其他许多人也都做到了。迄今为止，已有超过 1000 人跑出了 4 分钟以下的里程。

![Roger-Bannister-1951_jpg__1269-1600_](https://www.freecodecamp.org/news/content/images/2023/01/Roger-Bannister-1951_jpg__1269-1600_.png)像冠军一样奔跑 (照片: 大英百科全书)

而且，我也不是在做什么大胆的、史无前例的事情，比如在这里跑了 4 分钟的路程。多年来，很多著名的开发者都设法自学了编程。

见鬼，Ada Lovelace 在 19 世纪 40 年代就自学了编程。而她甚至没有一台可用的计算机。她只是了解了她的朋友 Charles Babbage 的计算机在理论上是如何工作的。

她写了几个最早的计算机算法。她被广泛认为是世界上第一个计算机程序员。没有人教她。因为没有人可以教她。无论她有什么自我怀疑，她显然克服了这种怀疑。

我不是 Ada Lovelace。我只是一个已经有了一台可以使用的电脑、一个体面的互联网连接、以及用谷歌搜索数十亿网页的能力的老师。

我掰开指关节，眯起眼睛。我本来打算这样做的。

### 陷入教程地狱

> "如果你工作了 10 年，你是得到了 10 年的经验还是得到了 1 年 10 次的经验？你必须对你的活动进行反思，以获得真正的经验。如果你把学习作为一个持续的承诺，你会得到经验。如果你不这样做，你就不会，无论你有多少年的经验。" - Steve McConnell，软件工程师
...
人类心理学是个有趣的东西。当事情开始变得困难的时候，我们会问：我这样做对吗？

也许这个教程已经过时了。也许它的作者不知道他们在说什么。甚至还有人在使用这种编程语言吗？

当你在编码过程中面对模棱两可的错误信息时，另一边的草开始显得更绿了。

假装我已经取得了进展是很容易的。是时候去吃午饭了。

我在咖啡馆里看到一个朋友。"你的编码工作进展如何？"他们会问。

"很好。我今天已经编码了 4 个小时。"

"太棒了。有机会我很想看看你在做什么。"

"当然，"我说，即使我知道我什么都没做。"很快。"

也许我会去书店，买一本新的 JavaScript 书。

买书是世界上最好的感觉。因为这也有种感觉你在购买时间来阅读它们。

而这正是我在学习代码的几周后发现自己的情况。
...
教程地狱是指你从一个教程跳到另一个教程，学习然后重新学习同样的基本东西。但从未真正超越基本原理。

因为超越基本原理——这需要一些真正的工作。

###培养一个程序员需要一个村庄

学习代码吸收了我所有的空闲时间。但我并没有取得什么进展。我现在可以在不看键盘的情况下输入`{`和`*`字符。但也就这样了。
...
好吧，我拨通了列出的号码，和一个叫 Steve 的人交谈。我紧张地问。"你们都不做违法的事，是吗？" Steve 笑了起来。
...
![1200x-1_jpg__1200-797_](https://www.freecodecamp.org/news/content/images/2023/01/1200x-1_jpg__1200-797_.png)Facebook 的企业园区在混凝土上用巨大的字母写着“黑客”一词。 （图片来源：彭博社）
...
我们一起吃了三明治。我对他说。"我可以在我的整个职业生涯中编码，但不能像你一样好。如果 10 年后我的代码能达到你的一半，我就会很兴奋。"

但 Steve 反驳了。他说，"我没有什么特别的。不要限制自己。如果你坚持编码，你可以轻易地超过我。"
...
史蒂夫说："我希望你用 HTML5 建立一个项目。下周六，我希望你在黑客空间（hackerspace）展示它。"
