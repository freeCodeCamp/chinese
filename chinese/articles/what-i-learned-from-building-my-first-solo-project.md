...
但我还是在犹豫要不要开始做，因为我总觉得自己还没有准备好。我当时只是略懂HTML,和CSS，对JavaScript也只是有一些初步了解。
...
我还遇到了多个样式表的问题。由于我重复使用了许多相同的样式，因此建立一个主样式表然后将其链接到所有HTML页面会比较合适。
...
终于做好一切准备后，我决定上线我的网站。我用  [Bluehost][13]  注册了一个自定义的域名，然后阅读了如何将GitHub网页设置为实时站点的有关说明。
